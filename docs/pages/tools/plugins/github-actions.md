...
!!! note "Note"
    It is not rocket science. We ask github for an ubunutu environment, we install the [Astra CLI](../../../pages/astra/astra-cli.md) and 
...
If you are not familiar with the CLI all available commands are available in [the documentation]([Astra CLI](../../../pages/astra/astra-cli.md)) or in the help of the tools
